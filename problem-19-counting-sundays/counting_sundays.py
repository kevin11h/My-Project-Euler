...
class Date:
    ...
    def to_day_number(self):
        ...
        for mm in range(1, self.month + 1):
    ...
    def days_away_from(self, date2):
        ...
        if start_date.year is end_date.year:
            ...
            day_count += days_in_year(start_date.year) - start_date.to_day_number()
            day_count += end_date.to_day_number()
...
def find_num_sundays_that_fall_on_first_of_each_month_between_years():
    YEAR_START = 1901
    YEAR_END = 2000
    REFERENCE_DATE = Date(11, 9, 2013)
    REFERENCE_DAY_OF_WEEK = "WED"
    TARGET_DAY = "SUN"
